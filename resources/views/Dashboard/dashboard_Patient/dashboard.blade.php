...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<div>
						  <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">لوحة تحكم موظفي المخبر </h2><br>
				...
				<div class="row row-sm">
					...
					<div class="col-xl-4 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-danger-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">إجمالي الدفوعات</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											 <a href='{{ route('payments.patient') }}'><h4 class="tx-20 font-weight-bold mb-1 text-white">{{App\Models\PatientAccount::where('patient_id',auth()->user()->id)->sum('credit')}}ألف</h4></a> 
										</div>
									</div>
								</div>
							</div>
