    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                <li><a class="slide-item" href="{{route('invoicesRays.index') }}">{{trans('main-sidebar_trans.view all')}}</a></li>
                <li><a class="slide-item" href="{{route('CompletedInvoices.Rays') }}">{{trans('Invoices.completed_invoices')}}</a></li>
                </ul>
            </li>
