...
<aside class="app-sidebar sidebar-scroll">
  ...
  @if (\Auth::guard('admin')->check())
     @include('Dashboard.layouts.main-sidebar.main-sidebar_admin') 
  @endif

  @if (\Auth::guard('doctor')->check())
     @include('Dashboard.layouts.main-sidebar.main-sidebar_doctor') 
  @endif

  @if (\Auth::guard('ray_employee')->check())
     @include('Dashboard.layouts.main-sidebar.main-sidebar_ray_employee') 
  @endif
  
  @if (\Auth::guard('laboratorie_employee')->check())
  @include('Dashboard.layouts.main-sidebar.main-sidebar_laboratorie_employee') 
  @endif

  @if (\Auth::guard('patient')->check())
  @include('Dashboard.layouts.main-sidebar.main-sidebar_patient') 
  @endif
</aside>
<!-- main-sidebar -->