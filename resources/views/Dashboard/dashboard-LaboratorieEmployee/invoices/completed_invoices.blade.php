                        ...
                        <table class="table text-md-nowrap" id="example1">
                            ...
                            @foreach($invoices as $invoice)
                                <tr>
                                    ...
                                    <td><a href="{{ route('ViewLaboratorie',$invoice->id)}}">{{ $invoice->Patient->name }}</a></td>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <a class="dropdown-item" href="{{route('invoiceLaboratorie.edit', $invoice->id)}}"><i class="text-primary fa fa-stethoscope"></i>&nbsp;&nbsp;اضافة تشخيص </a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
