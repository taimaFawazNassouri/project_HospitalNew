                    ...
                    <div class="card-body">
                        ...
                        <div class="row mg-t-20">
                            ...
                            <div class="col-md">
                                ...
                                <p class="invoice-info-row"><span>الدكتور</span> <span>{{ Request::get('doctor_id') }}</span></p>
                                <p class="invoice-info-row"><span>المريض</span> <span>{{ Request::get('patient_id') }}</span></p>
                                <p class="invoice-info-row"><span>القسم</span> <span>{{ Request::get('section_id') }}</span></p>
                            </div>
                        </div>
