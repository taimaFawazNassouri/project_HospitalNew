...
<div class="table-responsive">
        ...
        @foreach ($single_invoices as $single_invoice)
            <tr>
                ...
                <td>
                    ...
                    <button wire:click="print({{ $single_invoice->id }})" class="btn btn-primary btn-sm" title="طباعه سند صرف"><i class="fas fa-print"></i></button>
    ...
    @include('livewire.Single_Invoice.delete')
